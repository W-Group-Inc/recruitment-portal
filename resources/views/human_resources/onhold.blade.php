...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="text-muted fw-normal mt-0 text-truncate">On Hold MRF</h5>
                            <h3 class="my-2 py-1">{{count($onhold_mrf)}}</h3>
                        </div>
                    </div>
                </div> 
            </div>
    ...
    <div class="row">
        <div class="col-12">
            <h5 class="header-title">On-Hold MRF</h5>
            <div class="card">
                <div class="card-body">
